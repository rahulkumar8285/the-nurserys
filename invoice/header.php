  ...
  <aside class="main-sidebar">
    ...
    <section class="sidebar">
      ...
      <ul class="sidebar-menu">
        ...
        <!-- Menu 0 -->
        <li class="treeview">
          <a href="#"><i class="fa fa-file-text"></i></i><span>Quotation</span>
            <span class="pull-right-container">
              <i class="fa fa-angle-left pull-right"></i>
            </span>
          </a>
          <ul class="treeview-menu">
            <li><a href="quotation-add.php"><i class="fa fa-plus"></i>Add Quotation</a></li>
            <li><a href="quotation-list.php"><i class="fa fa-cog"></i>Manage Quotation</a></li>
          </ul>
        </li>
